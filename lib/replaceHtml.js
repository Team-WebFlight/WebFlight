...
const addStatusBar = require('./addStatusBar')

function replaceHtml (htmlStringsArray, statusBar, seedObj) {
  ...
  if (typeof statusBar === 'undefined') return addStatusBar(htmlStrings, seedObj)
  else return htmlStrings
}
